                ...
                <ComboBox
                    ...
                    itemToElement={(item) =>
                        <div style={{ height: "60px", display: "flex", flexDirection: "row", alignItems: "center" }}>
                            <img src={item.imageId ? `https://rect-zmzt.onrender.com//profile/image/${item.imageId}` : bg} style={{ height: "50px", width: "50px", borderRadius: "50%", objectFit: "cover", marginRight: "15px" }} alt="profile pic" />
                            {item.name} <br />
                            {item.email}
                        </div>
                    }
